...
public class thenlper_gte_smallInput : MLFeatureProvider {
    ...
    public var token_type_ids: MLMultiArray

    /// attention_mask as 1 by 512 matrix of 32-bit integers
    public var attention_mask: MLMultiArray

    public var featureNames: Set<String> { ["input_ids", "token_type_ids", "attention_mask"] }
    ...
    public init(input_ids: MLMultiArray, token_type_ids: MLMultiArray, attention_mask: MLMultiArray) {
        self.input_ids = input_ids
        self.token_type_ids = token_type_ids
        self.attention_mask = attention_mask
    }

    public convenience init(input_ids: MLShapedArray<Int32>, token_type_ids: MLShapedArray<Int32>, attention_mask: MLShapedArray<Int32>) {
...
@available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
public class thenlper_gte_smallOutput : MLFeatureProvider {
...
@available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
public class thenlper_gte_small {
    ...
    */
    public class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<thenlper_gte_small, Error>) -> Void) {
    ...
    /**
        ...
        - parameters:
          - configuration: the desired model configuration
    */
    public class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> thenlper_gte_small {
    ...
    /**
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    public class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<thenlper_gte_small, Error>) -> Void) {
    ...
    /**
        ...
        - parameters:
          ...
          - configuration: the desired model configuration
    */
    public class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> thenlper_gte_small {
    ...
    */
    public func prediction(input: thenlper_gte_smallInput) throws -> thenlper_gte_smallOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as thenlper_gte_smallOutput
    */
    public func prediction(input: thenlper_gte_smallInput, options: MLPredictionOptions) throws -> thenlper_gte_smallOutput {
    ...
    */
    ...
    public func prediction(input: thenlper_gte_smallInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> thenlper_gte_smallOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as thenlper_gte_smallOutput
    */
    public func prediction(input_ids: MLMultiArray, token_type_ids: MLMultiArray, attention_mask: MLMultiArray) throws -> thenlper_gte_smallOutput {
    ...
    */
    ...
    public func prediction(input_ids: MLShapedArray<Int32>, token_type_ids: MLShapedArray<Int32>, attention_mask: MLShapedArray<Int32>) throws -> thenlper_gte_smallOutput {
        let input_ = thenlper_gte_smallInput(input_ids: input_ids, token_type_ids: token_type_ids, attention_mask: attention_mask)
        return try prediction(input: input_)
    }
    ...
    /**
        ...
        - returns: the result of the prediction as [thenlper_gte_smallOutput]
    */
    public func predictions(inputs: [thenlper_gte_smallInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [thenlper_gte_smallOutput] {
